...
export type BorrowIncentivePoolPoints = { currentPointIndex: number; coinDecimal: number } & Required<
  Pick<ParsedBorrowIncentivePoolPointData, 'points' | 'distributedPoint' | 'weightedAmount'>
>;
