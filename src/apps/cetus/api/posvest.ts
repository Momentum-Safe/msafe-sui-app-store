...
import {getClmmSdk, getFarmsSdk} from './config';
...
export const  getClmmPosReedeem = (
    txbParams: any,
    account: WalletAccount,
    network: SuiNetworks,
) => {
...
export const  getFarmsPosReedeem = async (
    ...
    clmmSdk!.Vest.buildRedeemPayload(txbParams.redeemParms.map((item: any) => {
        return {
            ...item,
