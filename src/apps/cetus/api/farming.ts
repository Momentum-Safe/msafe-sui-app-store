...
export const getFarmingAddLiquidityTxb = async (
  ...
  const txb: any = await peripherySdk.Farms.openPositionAddLiquidityStakePaylod(txbParams?.parameter);
  return txb;
};
...
export const getFarmingIncreaseLiquidityTxb = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.addLiquidityFixCoinPayload(txbParams?.parameter);
  return txb;
};
...
export const getFarmingDecreaseLiquidityTxb = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.removeLiquidityPayload(txbParams?.parameter);
  return txb;
};
...
export const getFarmingClaimFeeAndRewardTxb = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.claimFeeAndClmmReward(txbParams?.parameter);
  return txb;
};
...
export const getFarmingBatchHarvest = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.batchHarvestPayload(txbParams?.parameter);
  return txb;
};
...
export const getFarmingStake = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.depositPayload(txbParams?.parameter);
  return txb;
};
...
export const getFarmingUnstake = async (
  ...
  clmmSdk.senderAddress = account.address;
  const peripherySdk = new CetusPeripherySDK(peripheryConfig, clmmSdk);
  const txb: any = await peripherySdk.Farms.withdrawPayload(txbParams?.parameter);
  return txb;
};
