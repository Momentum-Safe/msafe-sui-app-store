...
import { SuiNetworks, TransactionSubType, EmberIntentionData, DepositAssetIntentionData } from '../types';

export class DepositAsset extends BaseIntention<EmberIntentionData> {
