...
export class AddLiquidityV3Intention extends BaseIntention<KRIYAIntentionData> {
  ...
  async build(): Promise<Transaction> {
    ...
    return sdk.Clmm.getTxbAddLiquidity(params);
  }

  static fromData(data: KRIYAIntentionData) {
    return new AddLiquidityV3Intention(data);
  }
}
