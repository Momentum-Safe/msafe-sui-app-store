...
export const DEFAULT_CLIENT_OPTIONS = {
  ...
  WebSocketConstructor: (typeof WebSocket !== 'undefined' ? WebSocket : undefined) as typeof WebSocket,
  callTimeout: 30000,
...
class RpcSubscription {
  ...
  async subscribe(client: WebsocketClient) {
    ...
    const newSubscriptionId = await client.makeRequest<number>(this.input.method, this.input.params);
